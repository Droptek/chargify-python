...
class TestSubscriptions(ChargifyTestCase):
    ...
    def test_construct_request(self):
        ...
        self.assertResult(
            result, '/subscriptions/123.json', 'PUT',
            '{"subscription": {"credit_card_attributes": '
            '{"expiration_month": "10", "full_number": "2", "expiration_year": "2030"}}}'
        )
        ...
        self.assertResult(
            result, '/subscriptions/123.json', 'DELETE',
...
class TestCharges(ChargifyTestCase):
    ...
    def test_construct_request(self):
        ...
        self.assertResult(
            result, '/subscriptions/123/charges.json', 'POST',
            '{"charge": {"amount": "1.00", "memo": '
            '"This is the description of the one time charge."}}'
        )
...
class TestComponents(ChargifyTestCase):
    ...
    def test_construct_request(self):
        ...
        self.assertResult(
            result, '/subscriptions/123/components/456/usages.json', 'POST',
...
class TestMigrations(ChargifyTestCase):
    ...
    def test_construct_request(self):
        ...
        self.assertResult(
            result, '/subscriptions/123/migrations.json', 'POST',
            '{"product_id": 1234}')
